...
import com.softserve.itacademy.kek.rest.old.model.User;
import com.softserve.itacademy.kek.rest.old.model.UserList;
...
public interface UsersApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Fields validation failed", response = ErrorList.class)})
    AddressList addUserAddresses(@PathParam("guid") String guid, AddressList addresses);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successful operation")})
    void deleteUserAddress(@PathParam("guid") String guid, @PathParam("addrguid") String addrguid);
    ...
    Address getUserAddress(@PathParam("guid") String guid, @PathParam("addrguid") String addrguid);
    ...
    AddressList getUserAddresses(@PathParam("guid") String guid);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Fields validation failed", response = ErrorList.class)})
    Address modifyUserAddress(@PathParam("guid") String guid, @PathParam("addrguid") String addrguid, Address address);
}
