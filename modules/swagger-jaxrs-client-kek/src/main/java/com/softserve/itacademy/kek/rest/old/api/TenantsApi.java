...
import com.softserve.itacademy.kek.rest.old.model.Address;
import com.softserve.itacademy.kek.rest.old.model.AddressList;
import com.softserve.itacademy.kek.rest.old.model.ErrorList;
import com.softserve.itacademy.kek.rest.old.model.Tenant;
import com.softserve.itacademy.kek.rest.old.model.TenantList;
import com.softserve.itacademy.kek.rest.old.model.TenantProperty;
import com.softserve.itacademy.kek.rest.old.model.TenantPropertyList;
...
public interface TenantsApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Fields validation failed", response = ErrorList.class)})
    AddressList addTenantAddresses(@PathParam("guid") String guid, AddressList addresses);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Fields validation failed", response = ErrorList.class)})
    TenantPropertyList addTenantProperties(@PathParam("guid") String guid, TenantPropertyList properties);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successful operation")})
    void deleteTenantAddress(@PathParam("guid") String guid, @PathParam("addrguid") String addrguid);
    ...
    Address getTenantAddress(@PathParam("guid") String guid, @PathParam("addrguid") String addrguid);
    ...
    AddressList getTenantAddresses(@PathParam("guid") String guid);
    ...
    TenantPropertyList getTenantProperties(@PathParam("guid") String guid);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Fields validation failed", response = ErrorList.class)})
    Address modifyTenantAddress(@PathParam("guid") String guid, @PathParam("addrguid") String addrguid, Address address);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = "Fields validation failed", response = ErrorList.class)})
    TenantProperty modifyTenantProperty(@PathParam("guid") String guid, @PathParam("propguid") String propguid, TenantProperty property);
}
